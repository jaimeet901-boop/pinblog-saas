/**
 * Production default legal page templates for Seodeva.
...
export const SITE_URL = 'https://seodeva.com';
export const PRIVACY_EMAIL = 'contact@seodeva.com';
export const SUPPORT_EMAIL = 'contact@seodeva.com';
export const PLATFORM_NAME = 'Seodeva';
...
function materializeLegalText(value, brand) {
	...
	return String(value || '')
		.replaceAll('https://seodeva.com', b.siteUrl)
		.replaceAll('contact@seodeva.com', b.supportEmail)
		...
		.replaceAll('seodeva.com', host)
		.replaceAll('Chef IA', b.platformName)
		.replaceAll('Seodeva', b.platformName);
}
...
This Privacy Policy explains how Seodeva ("Seodeva," "we," "us," or "our") collects, uses, shares, and protects personal information when you use our website and services at ${SITE_URL} and related applications.

## 1. Introduction

Seodeva is an AI-assisted content and publishing platform that helps creators write SEO-ready articles, generate images and Pinterest pins, manage brand kits and templates, and publish to connected websites, WordPress sites, and Pinterest accounts.

By creating an account, connecting third-party services, or otherwise using Seodeva, you acknowledge that your information will be handled as described in this Privacy Policy. If you do not agree, please do not use the Service.
...
Seodeva authenticates users through secure account credentials managed by our platform infrastructure. Session tokens and related authentication artifacts are used to keep you signed in and to authorize API requests to your workspace.
...
Each Seodeva account operates within one or more workspaces. Workspace data may include team or owner settings, connected sites and accounts, content drafts, generation history, publishing queues, calendars, analytics summaries, notification preferences, and credit or subscription usage.

Workspace data is accessible to authorized users of that workspace and to Seodeva personnel solely as needed to provide support, maintain the platform, investigate abuse or security incidents, or meet legal obligations. We do not use your private workspace content to train public models for unrelated third parties.

## 5. Website connections

When you add a website to Seodeva, we may store the site URL, display name, discovery settings, article metadata you sync or import, and related destination links used for pin publishing.
...
If you connect a WordPress site, Seodeva stores the connection details required to authenticate and publish on your behalf, which may include site URL, authentication credentials or application passwords, author mapping, and publish status records.
...
When you connect Pinterest, Seodeva uses Pinterest’s OAuth 2.0 flow. With your authorization, we may receive and store account identifiers, username or profile details, granted OAuth scopes, access and refresh tokens, board identifiers and names, and pin publish results.

- Tokens are used to create and manage pins, sync boards, and retrieve related publishing status for your connected accounts.
- We store the OAuth application identifiers associated with your connection so we can validate that tokens belong to the configured Seodeva Pinterest developer app.
- You may disconnect Pinterest accounts from Seodeva at any time. Disconnecting cancels pending publish jobs tied to that account where technically feasible.
...
Seodeva uses third-party AI providers to generate text, images, and related outputs. Depending on platform configuration and the features you use, this may include providers such as OpenAI, Google Gemini, Fal.ai, and other models enabled by the Seodeva Admin Console.
...
- Provider API keys are managed by Seodeva for platform-operated providers and are not exposed to end users.
...
Seodeva uses cookies and similar technologies that are necessary to operate the Service, maintain secure sessions, remember preferences such as theme settings, and protect against abuse.
...
Seodeva provides in-product analytics for your workspace, such as counts of articles, images, published pins, scheduled jobs, and related performance summaries derived from your own connected accounts and publishing activity.

We also collect operational analytics about Service usage to monitor platform performance, prevent abuse, and improve Seodeva. These metrics are used for product operations and are not sold to data brokers.
...
Seodeva is intended for business and creator use by adults. The Service is not directed to children under 16, and we do not knowingly collect personal information from children. If you believe a child has provided personal information to us, contact ${PRIVACY_EMAIL}.
...
These Terms of Service ("Terms") govern your access to and use of Seodeva at ${SITE_URL}. By creating an account or using the Service, you agree to these Terms.

## 1. The Service

Seodeva provides AI-assisted writing, image and pin generation, brand kits, templates, calendars, analytics, and publishing integrations with websites, WordPress, and Pinterest.

## 2. Accounts and workspaces

You must provide accurate registration information and keep your credentials secure. You are responsible for activity under your account and workspace. You must be at least 16 years old to use Seodeva.
...
You retain ownership of content you upload or create. You grant Seodeva a limited license to host, process, and transmit that content solely to operate the Service and complete actions you request, including AI generation and publishing.
...
WordPress, Pinterest, OpenAI, Gemini, and other providers are governed by their own terms. Seodeva is not responsible for outages, policy changes, or access-tier restrictions imposed by those providers.
...
The Service is provided "as is" to the fullest extent permitted by law. Seodeva is not liable for indirect, incidental, or consequential damages arising from use of the Service.
...
This Cookie Policy explains how Seodeva uses cookies and similar technologies on ${SITE_URL}.
...
### Analytics cookies
Help us understand aggregate product usage, reliability, and feature adoption so we can improve Seodeva.
...
The information and tools provided by Seodeva at ${SITE_URL} are for general business and creator use.

## 1. No professional advice

Seodeva does not provide legal, financial, tax, medical, or other professional advice. Content generated or published through the Service should be reviewed by qualified professionals where appropriate.
...
Results on WordPress, Pinterest, and other connected services depend on those platforms’ availability, policies, and your account permissions. Seodeva is not responsible for rejected posts, sandbox restrictions, API access tiers, or account actions taken by third parties.
...
This Refund Policy explains how Seodeva handles subscription and credit-related refunds for services purchased through ${SITE_URL}.
...
export const LEGAL_PAGE_TEMPLATES = Object.freeze([
	buildTemplate({
		...
		description: 'Explain how Seodeva collects, uses, and protects account, workspace, WordPress, Pinterest, and AI data.',
		seoTitle: 'Privacy Policy | Seodeva',
		metaDescription: 'Learn how Seodeva collects, uses, and protects your account, workspace, website, WordPress, Pinterest, and AI-related data on seodeva.com.',
	...
	buildTemplate({
		...
		seoTitle: 'Terms of Service | Seodeva',
		metaDescription: 'Read the Seodeva Terms of Service governing account use, workspaces, publishing integrations, AI features, and acceptable use on seodeva.com.',
		content: TERMS_CONTENT,
	}),
	buildTemplate({
		slug: 'cookies',
		title: 'Cookie Policy',
		description: 'Describe essential, preference, and analytics cookies used to run secure sessions and improve Seodeva.',
		seoTitle: 'Cookie Policy | Seodeva',
		metaDescription: 'Learn how Seodeva uses essential, preference, and analytics cookies to operate secure sessions and improve the product on seodeva.com.',
		content: COOKIES_CONTENT,
	}),
	buildTemplate({
		slug: 'disclaimer',
		title: 'Disclaimer',
		description: 'Clarify AI output limits, third-party platform risk, and that Seodeva does not provide professional advice.',
		seoTitle: 'Disclaimer | Seodeva',
		metaDescription: 'Seodeva disclaimer covering AI-generated content, publishing integrations, third-party platforms, and informational use of the Service.',
	...
	buildTemplate({
		...
		seoTitle: 'Refund Policy | Seodeva',
		metaDescription: 'Seodeva refund policy for subscriptions, credits, and billing disputes on seodeva.com.',
