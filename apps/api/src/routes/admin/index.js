...
import authenticationProvidersRouter from './authentication-providers.js';
...
router.use('/ai-runtime', aiRuntimeRouter);
...
router.use('/authentication-providers', authenticationProvidersRouter);
