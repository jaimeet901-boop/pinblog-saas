 ...
 * Keep in sync with apps/web/src/lib/pinGenerationConstants.js
 */
...
export function isRecoverableGenerationError(code) {
	return PIN_GENERATION_RECOVERABLE_CODES.includes(String(code || ''));
}
