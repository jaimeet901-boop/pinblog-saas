			...
			newBaseCollection(
				...
				[
					...
					{ type: "json", name: "performance", maxSize: 100000 },
					{
						...
						name: "image_source",
						maxSelect: 1,
						values: ["featured", "ai_generated", "featured_fallback", "featured_composed"],
					},
					{
						type: "select",
						name: "image_generation_status",
						maxSelect: 1,
						values: ["idle", "queued", "processing", "completed", "failed", "fallback", "rendering"],
					},
					...
					{ type: "text", name: "pinterest_account_id", max: 80 },
					{ type: "text", name: "pinterest_account_label", max: 255 },
				],
				[
