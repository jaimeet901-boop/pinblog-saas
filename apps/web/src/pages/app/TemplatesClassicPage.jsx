...
import './TemplatesClassicPage.css';
		...
		<div className="tpl-atelier">
			...
			<div className="tpl-atelier__actions">
				...
				<div className="flex flex-wrap gap-2">
					...
					{selectedTemplate ? (
						<Link
							to={`/app/ai-pins/templates/${selectedTemplate.id}/edit`}
							className="inline-flex items-center gap-2 rounded-xl border border-border bg-transparent px-3 py-1.5 text-xs font-medium hover:bg-secondary"
						>
							<Pencil size={14} /> Edit layers
						</Link>
					) : null}
				</div>
			</div>
					...
					<aside className="tpl-atelier__list p-4">
						<div className="mb-3 flex items-center justify-between gap-2">
							...
							<div className="flex items-center gap-2">
								...
								<Link
									to="/app/ai-pins/templates/new/edit"
									className="inline-flex items-center gap-2 rounded-xl border border-border bg-transparent px-3 py-1.5 text-xs font-medium hover:bg-secondary"
								>
									<Pencil size={14} /> Layer editor
								</Link>
							</div>
						</div>
